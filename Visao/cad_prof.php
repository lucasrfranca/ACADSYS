...
<head>
  ...
  <title> ACADSYS - Cadastro de Professor </title>
  ...
  <div class="container">
    <div class="form-container">
      ...
      <form method="POST" action="processa_cad.php">
        ...
        <div class="form-group">
          <label for="materias"> <font size="+1"> Marque as disciplinas em que leciona: </label></font><br>
        ...
        <button type="submit" name="submit_prof" class="btn btn-primary"> Enviar </button>
      </form>
    </div>
  </div>
